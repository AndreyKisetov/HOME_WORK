        ...
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          <h2 class="w3-text-grey w3-padding-16"><i
              class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Опыт работы</h2>
                <?php
                  $workExperience = [
                    'Front End Developer' => 'Jan 2015 - <span class="w3-tag w3-teal 
                                                   w3-round">Current</span>
              ...
              <?php foreach($workExperience as $workExperienceName => $Value): ?>
                <p><?php echo $workExperienceName; ?></p>
                  <div <h6 class="w3-text-teal">
                    	 <i class="fa fa-calendar fa-fw w3-margin-right"></i> </h6>
                             <?php echo $Value; ?>
                    <hr>
                  </div>
              <?php endforeach; ?>
